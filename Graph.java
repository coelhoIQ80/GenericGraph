...
public interface Graph<N extends Comparable<? super N>> {
	...
	/***********************************************************
	 * @param aNode the node to replace in the graph
	 * @param bNode the node to be added to the graph
	 * @return true if the node was replaced to the graph
	 ***********************************************************/
	public boolean replaceNode(N aNode, N bNode);
