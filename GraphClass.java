...
* @since 2008/05/01 (v1.0), 2008/05/08 (v2.0)
* 
* @param <N> the type of the elements in the graph
***********************************************************/
public class GraphClass <N extends Comparable<? super N>> implements Graph<N>
{
	...
	***********************************************************/
	...
	/* (non-Javadoc)
	 * @see poo.IGraph#replaceNode(N)
	 */
	public boolean replaceNode(N aNode, N newNode)
	{
		...
		return (nodes.set(nodeId, newNode).equals(aNode));
	}
	...
	public int distanceTo(N endNode)
	  ...
	  private ArrayList<Iterator<N>> paths;
